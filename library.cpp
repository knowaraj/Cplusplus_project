...
void Book::add() {
    fb.open("library.txt", ios::app | ios::binary);
    Book b;
    cout << "\nEnter Book id :  ";
    cin >> b.sn;
    cout << "\nEnter Book name :  ";
...
bk:
    ...
    fi.open("issue.txt", ios::app | ios::binary);
    cout << "\n\tEnter student name : ";
    cin.ignore();
...
void Student::retbook() {
    ...
    int id, sn, check = 0;
    system("cls");
    fi.open("issue.txt", ios::in | ios::binary);
